...
# TODO определить границы гласных в распознавалке
#  виспер создает сеги с границами предложений
# фласк - подаем файл на вход - переводит на какой-то язык / перехватывать звук с микрофона


# TODO переписать БД сегов на sql alchemy


# любой язык со стат типизацией -> питон (циклы, условия, ввод-вывод)
# находить шаблоны в тексте типа прил+сущ (4 самых частотных шаблона в тексте) - научиться их нормализовать
